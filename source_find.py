...
# load images
img_array = np.load(dir_path + "img_array.npy")

# load data
data_array = np.load(dir_path + "data_array.npy")
...
# Training
myCNN.fit(train_X, train_Y, epochs=10, batch_size=128, shuffle=True, validation_data=(test_X, test_Y))
